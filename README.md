![docker image](https://github.com/ka-sarthak/NOMAD-dev-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ka-sarthak/NOMAD-dev-oasis.git
    cd NOMAD-dev-oasis
    ```
    ...
    ```sh
    curl-L -o NOMAD-dev-oasis.zip "https://github.com/ka-sarthak/NOMAD-dev-oasis/archive/main.zip"
    unzip NOMAD-dev-oasis.zip
    cd NOMAD-dev-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/ka-sarthak/NOMAD-dev-oasis:main` for the services
